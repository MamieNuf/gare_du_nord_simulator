...
hero = Actor("thomas", anchor=('middle', 'bottom'))
hero.pos = (64, GROUND)
...
def draw():
    ...
    if game_state == TITLE:
        draw_text_center("Evasion Urbaine", 60, "blue", -50)
...
def on_key_down(key):
    global hero_speed, game_state, boxes, vertical_enemy, next_box_time, next_vertical_enemy_time, lives, invincibility_time, can_jump, score
...
def reset_game():
    global hero_speed, boxes, vertical_enemy, next_box_time, next_vertical_enemy_time, lives, invincibility_time, game_state, can_jump, score
    hero.pos = (64, GROUND)
    hero_speed = 0
    boxes = []
    vertical_enemy = None
